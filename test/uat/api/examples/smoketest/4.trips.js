...
describe("ES integration: Trip full flow case 1", function() {
	...
	it("gets all active trips for passenger",function(){
		var req = endpointMikeqa + "/users/"+psg3+"/trips/_search/active";
		params = apiHelper.genTokenUserCreation_NotAdmin(id, psg3)
		console.log(req)
		var apiResponse = chakram.post(req, {}, params);
		apiResponse.then(function(json) {
				console.log(json.body._links)
	...
	it("gets all active trips for driver",function(){
		var req = endpointMikeqa + "/users/"+driver_user_id+"/trips/_search/active";
    params = apiHelper.genTokenDriverCreation_NotAdmin(id, driver_user_id)
		console.log(req)
		var apiResponse = chakram.post(req, {}, params);
		apiResponse.then(function(json) {
